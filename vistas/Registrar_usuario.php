  ...
  <body>
    ...
    <form class="form-horizontal" method="post" action="../procesos/add_usuario.php">
      <fieldset>
        ...
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="Rolid">RolId</label>  
          <div class="col-md-4">
            <input id="Rolid" name="Rolid" type="number" placeholder="Seleccione el tipo de usuario" class="form-control input-md" required="">
          </div>
        </div>
