...
<body>
  ...
  <form class="form-horizontal" method="post" action="../../../procesos/investigadores/Add_caso/Crear_Caso.php">
    <fieldset>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="Expediente">Numero Expediente</label>  
        <div class="col-md-4">
