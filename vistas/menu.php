...
<body>
  ...
  <ul class="navbar-nav">
      ...
      <a class="btn btn-primary navbar-brand" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <!-- icono del home de la casa -->
