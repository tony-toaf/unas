...
<body>
  ...
  <form  action="../../procesos/peritos/aliminar_numero.php" class="form-horizontal" method="post">
    <fieldset>
      <!-- Form Name -->
      <legend style="text-align: center;">EDITAR NUMERO DE  TELEFONO</legend>

      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label">Numero de Telefono a Editar:</label>  
        <div class="col-md-4">
          <input id="USERNAME" name="numero" type="text" placeholder="numero de numero telefonico" class="form-control input-md" required="">
        </div>
      </div>

      <div class="form-group">
        <label class="col-md-4 control-label">Nuevo Numeo Telefonico:</label>  
        <div class="col-md-4">
          <input id="USERNAME" name="numero" type="text" placeholder="Introduce El Nuevo  numero telfonico" class="form-control input-md" required="">
        </div>
      </div>
