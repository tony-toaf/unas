  ...
  <form  action="../../procesos/peritos/aliminar_numero.php" class="form-horizontal" method="post">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="USERNAME" name="numero" type="text" placeholder="Numero" class="form-control input-md" required="">
        </div>
      </div>

      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label">Numero Expediente</label>  
        <div class="col-md-4">
